...
try:
    ...
    print "Error importing Image library, try"
    print
    print "    apt-get install build-dep python-imaging libjpeg62 libjpeg62-dev"
    print
    sys.exit(1)
...
try:
    ...
    print
    print "    apt-get install python-numpy"
    print
    sys.exit(1)
...
try:
    ...
    print "Error importing libraries, try"
    print
    print "    apt-get install python-opengl"
    print
    sys.exit(1)
